...
var spacecatApp = angular.module('spacecatApp',[]); // make a module; set the scope of our application to be stored in an array

spacecatApp.controller('CatListCtrl',function($scope){ // function takes a global variable called scope
  $scope.cats = [
    { "id": 1,
      "name": "bigbelly",
